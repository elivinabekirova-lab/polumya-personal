...
const S = {
  ...
  label: { color: "#607066", fontSize: 10.5, fontWeight: 800, textTransform: "uppercase", letterSpacing: ".09em", margin: "12px 0 7px" },
  input: { background: "#FFFFFF", border: "1px solid #CDD7CF", color: "#1F2A24", borderRadius: 10, padding: "9px 11px", fontSize: 13.5, outline: "none" },
  inputFull: { width: "100%", background: "#FFFFFF", border: "1px solid #CDD7CF", color: "#1F2A24", borderRadius: 10, padding: "10px 11px", fontSize: 13.5, marginTop: 5 },
  primary: { background: "#3E7B55", color: "#FFFFFF", border: "1px solid #3E7B55", borderRadius: 10, padding: "9px 14px", fontWeight: 800, boxShadow: "0 6px 16px rgba(62,123,85,.18)" },
  ghost: { background: "#FFFFFF", color: "#34443A", border: "1px solid #D5DDD7", borderRadius: 10, padding: "7px 11px" },
  loginBtn: { background: "#FFFFFF", border: "1px solid #D5DDD7", color: "#34443A", borderRadius: 10, padding: "9px 16px", fontSize: 14 },
  subtleCenter: { textAlign: "center", color: "#718077", margin: "8px 0 20px", fontSize: 13 },
  bigBtn: { background: "#FFFFFF", border: "1px solid #D5DDD7", color: "#34443A", borderRadius: 10, padding: 13, fontWeight: 750 },
  bigOn: { background: "#EAF4ED", borderColor: "#8EC19D", color: "#2F6D49" },
  hint: { color: "#718077", fontSize: 12, lineHeight: 1.45 }, success: { color: "#2F7D4A", fontSize: 12.5, fontWeight: 700 }, error: { color: "#C9574F", fontSize: 12.5 },
  emberAmount: { color: "#B18431", fontSize: 27, fontWeight: 800 },
  grid3: { display: "grid", gridTemplateColumns: "repeat(3,minmax(0,1fr))", gap: 10, marginTop: 12 },
  mini: { background: "#F9FBF8", border: "1px solid #E1E7E1", borderRadius: 12, padding: 10, textAlign: "center", display: "grid", gap: 4 },
  pre: { whiteSpace: "pre-wrap", fontFamily: "Inter,sans-serif", lineHeight: 1.55, color: "#334239" }, footer: { textAlign: "center", color: "#829087", fontSize: 11, marginTop: 20 },
  linkBtn: { background: "none", border: 0, color: "#2F6D49", textDecoration: "none", padding: 0 },
  stats: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 10, marginBottom: 12 },
  stat: { background: "#FFFFFF", border: "1px solid #E1E7E1", borderRadius: 14, padding: "12px 14px", boxShadow: "0 5px 16px rgba(31,42,36,.045)" },
  tabs: { display: "flex", gap: 7, overflowX: "auto", paddingBottom: 7, marginBottom: 12, WebkitOverflowScrolling: "touch" },
  tab: { flex: "0 0 auto", background: "#FFFFFF", border: "1px solid #D8E0DA", color: "#526159", borderRadius: 10, padding: "8px 13px", fontSize: 12.5 },
  tabOn: { background: "#3E7B55", borderColor: "#3E7B55", color: "#FFFFFF", fontWeight: 800 },
  pointTabs: { display: "flex", gap: 6, flexWrap: "wrap", margin: "12px 0" }, sectionHead: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 10 },
  row: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap", background: "#FFFFFF", borderBottom: "1px solid #E1E7E1", padding: "10px 8px", marginBottom: 0 },
  chip: { background: "#FFFFFF", border: "1px solid #D8E0DA", color: "#526159", borderRadius: 9, padding: "6px 10px", fontSize: 12 }, chipOn: { background: "#EAF4ED", borderColor: "#8EC19D", color: "#2F6D49", fontWeight: 800 },
  formGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(210px,1fr))", gap: 9 }, field: { color: "#526159", fontSize: 12, fontWeight: 650 },
  cashInputRow: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, flexWrap: "wrap", padding: "9px 3px", borderBottom: "1px solid #E1E7E1" }, smallText: { display: "block", color: "#7F8C84", fontSize: 11, marginTop: 2 },
  calendarGrid: { display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 5 }, calendarDay: { minHeight: 34, borderRadius: 8, display: "grid", placeItems: "center", background: "#F7F9F6", border: "1px solid #D8E0DA", color: "#526159", fontSize: 11.5 },
  calendarFull: { background: "#3E7B55", borderColor: "#3E7B55", color: "#FFFFFF" }, calendarHalf: { background: "linear-gradient(135deg,#3E7B55 50%,#F7F9F6 50%)" }, calendarTraining: { background: "#E6B85C", color: "#FFFFFF" }, calendarOff: { background: "#DADFDA", color: "#5E6A62" },
  notice: { background: "#FBFCFA", borderLeft: "3px solid #E3B653", borderTop: "1px solid #E1E7E1", borderRight: "1px solid #E1E7E1", borderBottom: "1px solid #E1E7E1", borderRadius: 10, padding: 11, marginTop: 7, color: "#334239" },
  badge: { display: "inline-block", background: "#F5F8F5", border: "1px solid #CBD8CE", color: "#3E6D4C", padding: "6px 9px", borderRadius: 999, margin: "3px 5px 3px 0", fontSize: 11.5 },
  requestRow: { display: "flex", justifyContent: "space-between", gap: 10, padding: "9px 0", borderBottom: "1px solid #E1E7E1", color: "#334239", fontSize: 12 }, requestAdmin: { display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", background: "#FBFCFA", border: "1px solid #E1E7E1", borderRadius: 10, padding: 11, marginTop: 7 },
  progress: { height: 8, background: "#EEF2EE", border: "1px solid #DDE5DE", borderRadius: 20, overflow: "hidden", marginTop: 12 }, progressBar: { height: "100%", background: "linear-gradient(90deg,#3E7B55,#79A987)", borderRadius: 20 },
  metricRow: { display: "grid", gridTemplateColumns: "1.2fr repeat(3,1fr)", gap: 8, padding: "10px 4px", borderBottom: "1px solid #E1E7E1", color: "#334239", fontSize: 12.5 },
  alertRow: { background: "#FFF4F2", border: "1px solid #F0C5BF", color: "#B54D45", borderRadius: 9, padding: 9, marginTop: 6 }, auditRow: { display: "flex", justifyContent: "space-between", gap: 10, flexWrap: "wrap", padding: "9px 3px", borderBottom: "1px solid #E1E7E1", color: "#334239" },
  lineRow: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, padding: "9px 3px", borderBottom: "1px solid #E1E7E1", color: "#334239" }, detailBox: { background: "#FBFCFA", color: "#334239", border: "1px solid #E1E7E1", borderRadius: 9, padding: 9, marginTop: 6, fontSize: 12, lineHeight: 1.45 },
  savedRow: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, padding: "10px 3px", borderBottom: "1px solid #E1E7E1" },
  table: { width: "100%", borderCollapse: "collapse", fontSize: 12.5, color: "#334239", background: "#FFFFFF" }, stickyName: { position: "sticky", left: 0, background: "#FFFFFF", whiteSpace: "nowrap", padding: "8px 9px", zIndex: 1, border: "1px solid #E1E7E1" },
  cell: { width: 20, height: 20, borderRadius: 5, border: "1px solid #BFCAC2" }, nav: { background: "#FFFFFF", border: "1px solid #D8E0DA", color: "#526159", borderRadius: 9, width: 34, height: 34 },
  formBox: { display: "grid", gap: 8, background: "#FBFCFA", border: "1px solid #E1E7E1", borderRadius: 10, padding: 12, marginBottom: 12 }, textarea: { width: "100%", background: "#FFFFFF", border: "1px solid #CDD7CF", color: "#1F2A24", borderRadius: 10, padding: 11, fontSize: 13.5, lineHeight: 1.55 },
  statusPill: { background: "#F3F7F3", border: "1px solid #D8E0DA", color: "#617066", borderRadius: 999, padding: "5px 8px", fontSize: 10.5 },
  recommendationGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 8 }, recommendation: { background: "#FBFCFA", border: "1px solid #E1E7E1", borderRadius: 10, padding: 11, color: "#334239" }, recommendationHigh: { borderLeft: "3px solid #D66B61" }, recommendationWarning: { borderLeft: "3px solid #E0B453" }, recommendationSuccess: { borderLeft: "3px solid #6FA780" },
};